...
import { BookingModal, isBookingAvailable } from './BookingModal';
          ...
          <div className="mt-16 flex flex-col sm:flex-row gap-4">
            ...
            {isBookingAvailable && (
              <button
                ...
                className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium border border-light/30 text-light hover:border-light/60 transition-colors"
              >
                {dict.hero.cta.bookCall}
              </button>
            )}
          </div>
        </div>
